  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full h-[500px] md:h-[600px] overflow-hidden">
        ...
        <Image src="/images/hero-banner.jpg" alt="Productos agrícolas frescos" fill className="object-cover" priority />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="overflow-hidden">
              <div className="relative h-64">
                <Image src="/images/fresh-products.jpg" alt="Productos frescos" fill className="object-cover" />
              </div>
              <CardHeader>
            ...
            <Card className="overflow-hidden">
              <div className="relative h-64">
                <Image src="/images/processed-products.jpg" alt="Productos procesados" fill className="object-cover" />
              </div>
              <CardHeader>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 mb-12">
            ...
            <div className="w-40 h-24 relative grayscale hover:grayscale-0 transition-all">
              <Image src="/images/client-dosdelama.png" alt="Dos del Alma" fill className="object-contain" />
            </div>
          </div>
